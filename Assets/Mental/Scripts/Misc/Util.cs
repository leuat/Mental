...
public class Util : MonoBehaviour
{
    ...
    public static Vector3 randomVector(System.Random r, float x, float y, float z)
    {
        return new Vector3((float)r.NextDouble() * x, (float)r.NextDouble() * y, (float)r.NextDouble() * z);

    }

    public static string getComboValue(String s)
    {
